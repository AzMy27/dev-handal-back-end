...
async function seedPlaces() {
  const places = [
    {
      ...
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
      title: "Pantai Kuta",
      price: 0,
      ...
      location:
        "Pantai Kuta, Kuta, Badung Regency, Bali",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
    ...
    },
    {
      ...
      location:
        "Pantai Tanjung Aan, Lombok, West Nusa Tenggara",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
    ...
    },
    {
      ...
      location:
        "Candi Prambanan, Sleman, Special Region of Yogyakarta",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
...

    {
      ...
      description:
        "Candi Buddha terbesar di dunia yang terletak di Magelang, Jawa Tengah",
      location:
        "Candi Borobudur, Borobudur, Magelang, Central Java",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
      ...
      location:
        "Pulau Komodo, East Nusa Tenggara",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
    ...
    },
    {
      ...
      location:
        "Taman Safari Indonesia, Cisarua, West Java",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
    ...
    },
    {
      ...
      location:
        "Pulau Lombok, West Nusa Tenggara",
      image:
        "https://source.unsplash.com/collection/2349781/1280x720",
    },
    {
  ...
  //       let geoData = await hereMaps.geometry(
  //         place.location
  //       );
  //       if (!geoData) {
  //         geoData = {
  ...
  //           filename:
  //             "image-1681876521153-260851838.jpg",
  //         },
  //         geometry: { ...geoData },
  //       };
  //     })
